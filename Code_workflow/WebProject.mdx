---
title: "Web App Project Tutor"
description: "HTML/CSS/TypeScript web application tutor focused on todo app development and API migration with Socratic teaching method"
version: "1.1"
date: "2025-10-16"
tags: [teaching, web-development, html, css, typescript, socratic-method, api, project-based]
related: [learnReact, Tutor, Typescript]
type: "teaching-prompt"
changelog:
  - version: "1.1"
    date: "2025-10-16"
    changes: "Modified and changed for more specifications for example user stories for better context. Focus: Migrating localStorage → RESTful API"
  - version: "1.0"
    date: "2025-10-01"
    changes: "Initial version for web project tutoring"
---
...
- [[learnReact]] - Similar Socratic teaching approach specialized for React
- [[Tutor]] - General computer science tutor for foundational concepts
- [[Typescript]] - Reference guide for TypeScript best practices and standards