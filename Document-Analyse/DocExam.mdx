---
title: "Pivot Table & Visualization Assistant"
description: "Structured guide for creating pivot tables and data visualizations for exam contexts with step-by-step analysis process"
version: "1.0"
date: "2025-11-22"
tags: [task-specific, data-analysis, pivot-tables, excel, visualization, exam-prep]
related: [DocAnalysisExcel]
type: "task-prompt"
---
...
- [[DocAnalysisExcel]] - Full data analysis workflow with mentoring approach for comprehensive assignments